                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img class="slide-image" src="images/thebigbangtheory.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="images/thumb_2604_serieSlider_800.jpeg" alt="">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="images/91inSabroDL._SL1500_-800x300.jpg" alt="">
                                </div>
                            </div>
				...
				$disc =  substr (  $meta['episodedescription'] , 0 , 30  );
							echo '<div class="col-sm-4 col-lg-4 col-md-4">';
								echo '<div class="thumbnail">';
									echo '<img src="images/big-bang-theory-320x150.jpg" alt="">';
